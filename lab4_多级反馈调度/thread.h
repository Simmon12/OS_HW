...
struct thread
  {
    ...
    /* added to muliple priority scheduling*/
    int32_t nice;                      /*how nice the thread should be to other thread*/
    int64_t recent_cpu;                /* the cpu time of the thread has used recently*/
